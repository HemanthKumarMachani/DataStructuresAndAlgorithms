...
public class MaxSubArraySum {
    public static void main(String[] args) {
        ...
        System.out.println("maxSumKadanesAlgo results: " + Arrays.toString(printSubArrayWithMaxSum(input1))
                + " with sum " + maxSubArraySumKadanesAlgo(input1));
